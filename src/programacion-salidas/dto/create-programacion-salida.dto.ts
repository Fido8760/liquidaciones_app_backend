...
export class CreateProgramacionSalidaDto {
  ...
  @IsEnum(TipoUnidad, {
    message:
      'Debe seleccionar un tipo de unidad válido(TRACTOCAMION, MUDANCERO, CAMIONETA).',
  })
  ...
  @MaxLength(100, {
    message: 'El Cliente no puede tener más de 100 caracteres.',
  })
  ...
  @MaxLength(150, {
    message: 'El Destino no puede tener más de 150 caracteres.',
  })
  ...
  @Matches(/^([01]\d|2[0-3]):([0-5]\d)$/, {
    message: 'La hora de carga debe tener formato HH:mm.',
  })
  ...
  @IsDateString(
    {},
    { message: 'La fecha de descarga debe tener un formato válido.' },
  )
  @IsNotEmpty({ message: 'La fecha de descarga es obligatoria.' })
  fecha_descarga: string;

  @Matches(/^([01]\d|2[0-3]):([0-5]\d)$/, {
    message: 'La hora de descarga debe tener formato HH:mm.',
  })
